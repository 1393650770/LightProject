...
void ALightProjectCharacter::GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps) const
{
	...
	DOREPLIFETIME_WITH_PARAMS_FAST(ALightProjectCharacter, bIsPlayerSelf, SharedParams);
...
void ALightProjectCharacter::SetReloadFalseServerByCharacter_Implementation()
{
	IsReloading = false;
}
